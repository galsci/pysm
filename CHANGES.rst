...
- `apply_smoothing_and_coord_transform` now supports a different output resolution and supports doing both HEALPix and CAR in the same execution `PR 125 <https://github.com/galsci/pysm/pull/125>`_
