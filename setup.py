...
DESCRIPTION = metadata.get('description', 'Python Sky Model for Microwave and Submm experiments')
AUTHOR = metadata.get('author', 'Ben Thorne, David Alonso, Sigurd Naess, Jo Dunkley, Andrea Zonca')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: pysm requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
